...
| Basin findings, F̂ derivation, Lyapunov/Langevin/Kramers background (pull-only) | — | [theory/basins_of_attraction.md](theory/basins_of_attraction.md), [theory/free_energy_derivation.md](theory/free_energy_derivation.md), [theory/theory_background.md](theory/theory_background.md) |
